...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/Users/nirajmac/Downloads/HACKATHON/venv/bin',
 'BINLIBDEST': '/Users/nirajmac/Downloads/HACKATHON/venv/lib/python3.11',
 ...
 'BLDSHARED': 'arm64-apple-darwin20.0.0-clang -bundle -undefined '
              ...
              '-Wl,-rpath,/Users/nirajmac/Downloads/HACKATHON/venv/lib '
              '-L/Users/nirajmac/Downloads/HACKATHON/venv/lib '
              ''
              ''
              '-Wl,-pie -Wl,-headerpad_max_install_names '
              '-Wl,-dead_strip_dylibs '
 ...
 'CFLAGS': '-DNDEBUG -fwrapv -O2 -Wall '
           ...
           '-isystem '
           '/Users/nirajmac/Downloads/HACKATHON/venv/include '
           ' '
           ' '
           '-arch arm64  '
           ''
 ...
 'CONFIGURE_CPPFLAGS': ''
                       ...
                       '-I/Users/nirajmac/Downloads/HACKATHON/venv/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      '-Wl,-pie -Wl,-headerpad_max_install_names '
                      '-Wl,-dead_strip_dylibs '
 ...
 'CONFIG_ARGS': "'--prefix=/Users/nirajmac/Downloads/HACKATHON/venv' "
                "'--build=arm64-apple-darwin20.0.0' "
                "'--host=arm64-apple-darwin20.0.0' '--enable-ipv6' "
                "'--with-ensurepip=no' "
                "'--with-tzpath=/Users/nirajmac/Downloads/HACKATHON/venv/share/zoneinfo:/Users/nirajmac/Downloads/HACKATHON/venv/share/tzinfo' "
                "'--with-computed-gotos' '--with-system-ffi' "
                "'--enable-loadable-sqlite-extensions' "
                "'--with-tcltk-includes=-I/Users/nirajmac/Downloads/HACKATHON/venv/include' "
                "'--with-tcltk-libs=-L/Users/nirajmac/Downloads/HACKATHON/venv/lib "
                ...
                "'PKG_CONFIG_PATH=/Users/nirajmac/Downloads/HACKATHON/venv/lib/pkgconfig' "
                ...
                '-mmacosx-version-min=11.1 '
                "-I/Users/nirajmac/Downloads/HACKATHON/venv/include'",
 'CONFINCLUDEDIR': '/Users/nirajmac/Downloads/HACKATHON/venv/include',
 'CONFINCLUDEPY': '/Users/nirajmac/Downloads/HACKATHON/venv/include/python3.11',
 'COREPYTHONPATH': '',
 ...
 'DESTDIRS': '/Users/nirajmac/Downloads/HACKATHON/venv '
             '/Users/nirajmac/Downloads/HACKATHON/venv/lib '
             '/Users/nirajmac/Downloads/HACKATHON/venv/lib/python3.11 '
             '/Users/nirajmac/Downloads/HACKATHON/venv/lib/python3.11/lib-dynload',
 'DESTLIB': '/Users/nirajmac/Downloads/HACKATHON/venv/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/Users/nirajmac/Downloads/HACKATHON/venv/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/Users/nirajmac/Downloads/HACKATHON/venv/include '
                   '/Users/nirajmac/Downloads/HACKATHON/venv/include '
                   '/Users/nirajmac/Downloads/HACKATHON/venv/include/python3.11 '
                   '/Users/nirajmac/Downloads/HACKATHON/venv/include/python3.11',
 'INCLUDEDIR': '/Users/nirajmac/Downloads/HACKATHON/venv/include',
 'INCLUDEPY': '/Users/nirajmac/Downloads/HACKATHON/venv/include/python3.11',
 ...
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/Users/nirajmac/Downloads/HACKATHON/venv/lib/python3.11',
 'LIBDIR': '/Users/nirajmac/Downloads/HACKATHON/venv/lib',
 ...
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '/Users/nirajmac/Downloads/HACKATHON/venv/include',
 'LIBM': '',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/Users/nirajmac/Downloads/HACKATHON/venv/lib/pkgconfig',
 'LIBPL': '/Users/nirajmac/Downloads/HACKATHON/venv/lib/python3.11/config-3.11-darwin',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/Users/nirajmac/Downloads/HACKATHON/venv/lib/python3.11',
 ...
 'MANDIR': '/Users/nirajmac/Downloads/HACKATHON/venv/share/man',
 ...
 'MODULE_BINASCII_CFLAGS': '-DUSE_ZLIB_CRC32 '
                           '-I/Users/nirajmac/Downloads/HACKATHON/venv/include',
 'MODULE_BINASCII_LDFLAGS': '-L/Users/nirajmac/Downloads/HACKATHON/venv/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '-I/Users/nirajmac/Downloads/HACKATHON/venv/include',
 'MODULE_ZLIB_LDFLAGS': '-L/Users/nirajmac/Downloads/HACKATHON/venv/lib '
                        '-lz',
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/Users/nirajmac/Downloads/HACKATHON/venv/include',
 ...
 'MODULE__HASHLIB_LDFLAGS': '-L/Users/nirajmac/Downloads/HACKATHON/venv/lib   '
                            '-lcrypto',
 ...
 'MODULE__LZMA_CFLAGS': '-I/Users/nirajmac/Downloads/HACKATHON/venv/include',
 'MODULE__LZMA_LDFLAGS': '-L/Users/nirajmac/Downloads/HACKATHON/venv/lib '
                         '-llzma',
 ...
 'MODULE__SQLITE3_CFLAGS': '-I/Users/nirajmac/Downloads/HACKATHON/venv/include '
 ...
 'MODULE__SQLITE3_LDFLAGS': '-L/Users/nirajmac/Downloads/HACKATHON/venv/lib '
                            '-lsqlite3',
 'MODULE__SQLITE3_STATE': 'yes',
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/Users/nirajmac/Downloads/HACKATHON/venv/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/Users/nirajmac/Downloads/HACKATHON/venv/lib  '
                        '-lssl -lcrypto',
 ...
 'MODULE__TKINTER_CFLAGS': '-I/Users/nirajmac/Downloads/HACKATHON/venv/include '
                           '-Wno-strict-prototypes -DWITH_APPINIT=1',
 'MODULE__TKINTER_LDFLAGS': '-L/Users/nirajmac/Downloads/HACKATHON/venv/lib '
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/Users/nirajmac/Downloads/HACKATHON/venv/include',
 'OPENSSL_LDFLAGS': '-L/Users/nirajmac/Downloads/HACKATHON/venv/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/Users/nirajmac/Downloads/HACKATHON/venv/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/Users/nirajmac/Downloads/HACKATHON/venv/share/zoneinfo:/Users/nirajmac/Downloads/HACKATHON/venv/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 ...
 'WASM_ASSETS_DIR': './Users/nirajmac/Downloads/HACKATHON/venv',
 'WASM_STDLIB': './Users/nirajmac/Downloads/HACKATHON/venv/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'datarootdir': '/Users/nirajmac/Downloads/HACKATHON/venv/share',
 'exec_prefix': '/Users/nirajmac/Downloads/HACKATHON/venv',
 'prefix': '/Users/nirajmac/Downloads/HACKATHON/venv',
